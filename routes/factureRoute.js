...
const { getAllfacture,getFactureCount,getClientFacture ,getfactureById, updatefacture, createfacture, deletefacture } = require("../controllers/factureController"); 
...
router.get("/count", getFactureCount);
